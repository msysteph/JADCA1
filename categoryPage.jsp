...
<body>
	...
	<nav
		...
		<a href="javascript:void(0)" onclick="w3_close()"
			...
			href="listingPage.jsp" onclick="w3_close()"
			class="w3-bar-item w3-button">Our Drinks</a> <a
	...
	<div class="w3-main w3-content w3-padding"
		...
		<div class="w3-row-padding w3-padding-16 w3-center">
			...
			<%
				...
				.prepareStatement("SELECT id, name, description_short, image_location FROM menu WHERE product_category=?");
			...
			<div class="w3-quarter">
				<a href="drinkListing.jsp?id=<%=id%>&name=<%=name%>"
					style="text-decoration: none;"> <img src="<%=imageURL%>"
					alt="drink" style="width: 100%" class= "w3-bar-item w3-button">
					<h3><%=name%></h3>
				</a>
				<p><%=description%></p>
			</div>
