...
<body>
	...
	<%
		...
		"SELECT description_long, retail_price, product_category, image_location FROM menu WHERE id=?");
	...
	<div class="w3-container w3-padding-32 w3-center">
		<img src="<%=imageURL%>" alt="Drink" class="w3-image"
			style="display: block; margin: auto" width="400" height="533">
