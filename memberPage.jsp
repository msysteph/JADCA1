...
<body>
	...
	<div class="w3-main w3-content w3-padding"
		...
		<div class="w3-container w3-padding-32 w3-center">
			<h2>
				<b>Welcome to your member page, <%=username%>!
				</b>
			</h2>
			<div class="w3-padding-32">
				<table border='1'
					style='margin-left: auto; margin-right: auto; width: 25%; border-collapse: collapse;'>
					<thead>
				...
				<form action="memberPage.jsp?id=<%=qsID%>&update=true" method="post">
					<input style="margin-top: 15px;" type="submit" value="edit"
						name="edit" />
				</form>
		...
		<div class="w3-container w3-padding-32 w3-center">
			<form action="updateUser.jsp" method="post">
				<table style="margin-left: auto; margin-right: auto;">
					<thead>
						<h4>Edit Your User Details:</h4>
						<tr>
							<td height="50px" style="padding: 15px;"><label
						...
						<tr>
							<td><input type="hidden" value=<%=qsID%> name="id" /> <input
